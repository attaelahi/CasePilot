...
<head>
    ...
    <title>ClassesLog SuperAdmin - Manage Admins</title>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-sm">
                <div class="flex items-center justify-between p-4">
                    ...
                    <h1 class="text-xl font-semibold text-gray-800">Manage Admin Accounts</h1>
                    <div></div>
                </div>
            </header>
            ...
            <main class="flex-1 overflow-y-auto bg-gray-50 p-4 md:p-6">
                ...
                <div class="bg-white rounded-lg shadow">
                    <div class="p-4 border-b flex justify-between items-center">
                        <h2 class="text-lg font-semibold text-gray-800">Admin Accounts</h2>
                        <a href="add-admin.php" class="bg-purple-600 text-white px-4 py-2 rounded-md hover:bg-purple-700 transition-colors flex items-center">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <div class="flex space-x-2">
                                                        <?php if($row['status'] == 'active'): ?>
                                                            <a href="?toggle_status=1&id=<?php echo $row['id']; ?>&current_status=active" class="text-red-600 hover:text-red-900" onclick="return confirm('Are you sure you want to lock this admin account?')">Lock</a>
                                                        <?php else: ?>
                                                            <a href="?toggle_status=1&id=<?php echo $row['id']; ?>&current_status=locked" class="text-green-600 hover:text-green-900" onclick="return confirm('Are you sure you want to unlock this admin account?')">Unlock</a>
                                                        <?php endif; ?>
                                                        <a href="reset-admin-password.php?id=<?php echo $row['id']; ?>" class="text-blue-600 hover:text-blue-900">Reset Password</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php endwhile; ?>
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="6" class="px-6 py-4 text-center text-sm text-gray-500">No admin accounts found</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
